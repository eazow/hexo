...
逻辑学不是让你变成一台冷冰冰的推理机器，而是给你的思维装上一双**能看清迷雾的眼睛**。

当你下次听到一个听起来很有道理的说法，不妨停下来问三个问题：

> 1. **前提是什么？** 这些前提成立吗？
> 2. **推理过程有没有跳跃？** 结论真的从前提中来吗？
> 3. **有没有我没考虑到的反例？**

这三个问题，就是逻辑学送给你最实用的礼物。
...
> **逻辑学最迷人的地方，不是它告诉你答案——**
> **而是它告诉你，为什么你的第一感觉，有时候是个精心设计的陷阱。**

蒙提霍尔问题之所以经典，正是因为它用一道简单的游戏题，揭示了人类思维最普遍的盲点：**我们太容易忽略"信息是怎么来的"这个问题。**